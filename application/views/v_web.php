          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="form-group">
                <label for="exampleInputEmail1">INPUT KODE PEGAWAI DI SINI</label>
                <input type="text" onChang="redy()" id="id" class="form-control" placeholder="Masukkan Kode yang terdaftar di Data Karyawan">
              </div>
            </div>
